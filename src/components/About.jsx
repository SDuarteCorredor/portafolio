    ...
    <section id="sobre" className="container-x py-24 md:py-36">
      <div className="grid gap-14 md:grid-cols-12">
        <div className="md:col-span-7">
          <Reveal>
            <div className="mb-8 flex items-center gap-3">
              ...
              <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-mist">(05)</span>
            </div>
          </Reveal>
        ...
        <div className="md:col-span-5 md:pt-4">
          ...
          <Reveal>
            <div className="relative mb-6 grid place-items-center overflow-hidden rounded-2xl border border-white/10 bg-ink2 p-10">
              ...
              <div className="relative grid h-40 w-40 place-items-center">
                ...
                <div className="absolute inset-[3px] rounded-full bg-ink2" />
                <span className="relative font-grotesk text-6xl font-bold tracking-tightest text-paper">
                  SD<span className="text-santi">.</span>
                </span>
              </div>
              <span className="mt-6 inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.25em] text-mist">
          ...
          <div className="space-y-px overflow-hidden rounded-2xl border border-white/10">
            {about.facts.map((f, i) => (
              <Reveal key={f.k} delay={i * 0.06}>
                <div className="group flex flex-col gap-1 bg-ink2 p-6 transition-colors hover:bg-white/[0.03]">
                  <span className="font-mono text-xs uppercase tracking-widest text-santi-soft">{f.k}</span>
                  <span className="text-paper transition-transform duration-300 group-hover:translate-x-1">{f.v}</span>
                </div>
              </Reveal>
            ))}
          </div>
