      ...
      <Reveal>
        <div className="mb-14 flex flex-wrap items-end justify-between gap-x-10 gap-y-6">
          <div>
            ...
            <SplitText
              as="h2"
              text="Estrategia que se traduce en *ventas*."
              className="block max-w-2xl font-grotesk text-big font-bold leading-[1.02] tracking-[-0.02em]"
            />
          </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {stats.map((s, i) => (
          <Reveal key={i} delay={i * 0.06} className="h-full">
            <Tilt max={5} lift={4} className="h-full rounded-2xl">
              <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-line p-8 transition-colors duration-300 hover:border-santi/40 hover:bg-fg/[0.02] md:p-10">
