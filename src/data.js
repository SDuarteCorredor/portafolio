...
export const work = [
  ...
  },
  {
    ...
    accent: '#00D4FF',
    cover: '/img/casos/asignar.png',
    coverFit: 'contain',
    coverAlt: 'Embudo de tres anillos de vidrio suspendidos, con una línea de luz cian atravesándolos y cayendo sin resolver, representando el funnel de performance de Asignar.',
    ...
    link: 'https://asignar-taupe.vercel.app/',
    cta: 'Ver sitio',
  },
  {
    ...
    coverFit: 'contain',
    coverAlt: 'Silueta de un smartphone en vidrio esmerilado con el contorno trazado en cian eléctrico, representando el proyecto end-to-end de BLU.',
  ...
  },
  {
    ...
    accent: '#6B4CFF',
    cover: '/img/casos/aiiso-consulting.png',
    coverFit: 'contain',
    coverAlt: 'Constelación de nodos de vidrio conectados por líneas de luz índigo, representando la estrategia y presencia digital de AIISO Consulting.',
  ...
  },
  {
    ...
    accent: '#A3FF3D',
    cover: '/img/casos/growthbro.png',
    coverFit: 'contain',
    coverAlt: 'Un engranaje de vidrio esmerilado con el eje iluminado en verde lima, representando la operación de marketing montada desde cero en GrowthBro.',
  ...
  },
  {
    ...
    accent: '#FF2D55',
    cover: '/img/casos/nona-gastro-bar.png',
    coverFit: 'contain',
    coverAlt: 'Plato de vidrio esmerilado con un anillo de luz rojo vino trazado en el borde, representando la identidad y apertura de Nona Gastro Bar.',
  ...
  },
  {
    ...
    accent: '#FF3D8B',
    cover: '/img/casos/limonada-pink.png',
    coverFit: 'contain',
    coverAlt: 'Vaso de vidrio esmerilado con una rodaja de cítrico trazada en luz magenta, representando la marca de bebidas Limonada Pink.',
  ...
  },
  {
    ...
    coverFit: 'contain',
    coverAlt: 'Frasco gotero de vidrio esmerilado con la curva de crecimiento en ventas trazada en verde esmeralda por dentro, representando el +278% de Bio Laboratorios.',
